    ...
    <div>
      <header className="main-header header-style-two">
        ...
        <div className="mobile-menu">
          ...
          <div className="close-btn" onClick={handleToggleMobileSideNav}>
        ...
        <div className="inner-box">
          ...
          <div className="about-sec">
            ...
            <p>
              ...
              offering innovative web marketing solutions to mid to large size
              companies across the globe. As a leader in SEO, web design,
              ecommerce, website conversion, and Internet marketing services,
              our firm prides ourselves.
            </p>
            <Link
              to="/about"
              className="theme-btn btn-style-one"
          ...
          <div className="contact-info-box">
            ...
            <ul className="social-links">
              <li>
                <Link target="_blank" to="https://www.facebook.com/techdtm">
                  <i className="fab fa-facebook-f" />
                </Link>
              </li>
              <li>

                    ...
                    <div className="container-fluid">
                        ...
                        <div className="inner-container">
                            <div className="row clearfix">
                                ...
                                <div className="center-column col-xl-4 col-lg-12 col-md-12 col-sm-12">
                                    <div className="inner-column wow zoomIn" data-wow-delay="600ms">
                                        <div className="image-box">
                                            <figure>
                                                <img
                                                    src="images/resource/service-center.png"
                                                    alt="service center"
                                                />
                                            </figure>
                                        </div>
                                ...
                                <div
                                    className="right-column pull-right col-xl-4 col-lg-12 col-md-12 col-sm-12"
                                >
                                    <div className="inner-column">
                                        ...
                                        <div className="service-block-three">
                                            <div
                                                ...
                                                style={serviceBlock5}
                                            >
                                                <div className="icon-box yellow"><span className="icon flaticon flaticon-social-media"/>
                                                </div>
                                                <div className="text-box">
